...
#my_history_img_body{width:100%; height:1000px; border-top:1px solid #D8D8D8; margin-top:100px;}
...
$(document).ready(function(){
	...
	<div id="history">
		<div id="history_top">
			...
			<div id="history_info">
				<span style="font-size:30px;">${mdto.nickName }</span><button id="follow_btn">팔로우</button><br><br>
				<span>게시물 ${mdto.history_qtt }</span>
				<span id="follower" style="margin-left:5%;">팔로워 ${mdto.follow_qtt }</span>
