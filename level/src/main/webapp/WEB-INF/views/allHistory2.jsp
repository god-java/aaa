...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(data){
			var html1 = "<c:if test='${member_num==null }'><script type='text/javascript'>alert('잘못된 접근입니다') location.href='main'</script></c:if><script type='text/javascript'>$(document).ready(function(){var member_num = ${member_num}var history_num = 0$('#like_img_no').click(function(){history_num = $(this).attr('param')})
...
<style type='text/css'>
#allHistory{width:100%; overflow:hidden;}
</style>
</head>
<body>
